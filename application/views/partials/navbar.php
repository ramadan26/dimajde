...
<header class="full_header content-white mobile_menu">
	...
	<div class="side_menu">
			...
			<a href="" id="change_lang" class="lang" style="<?php if(!is_ar_lang()) {?>font-family:'DroidArabicKufiRegular';<?php } ?>"><?php echo lang_const('switch_to_lang'); ?></a>
			</div>
			...
			<div class="menu-footer right-boxed">
				<div class="social-list">
					...
					<a target="_blank" href="<?php echo $social[$i]->social_link; ?>" class="icon ion-social-<?php echo $social[$i]->social_title; ?>"></a>
