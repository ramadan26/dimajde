...
<!-- Mirrored from paul-themes.com/html/Dimajde/Dimajde-demo/Dimajde/light/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Aug 2018 11:15:25 GMT -->
...
<body>
    <div class="animsition">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="work-list.php">Product</a>
                        </li>
                        <li class="dropdown submenu">
                            <a href="work-masonry.php">Projects</a>
        ...
        <section class="about_image">
            <img class="img-fluid" src="img/blog/single-blog-3.jpg" alt="">
        </section>
        <section class="about_studio_area white_cl">
            <div class="container">
                <div class="ab_studio_text text-center">
                    <h2 class=" white">About Dimajde</h2>
                    <p class="lead">Make is a different kind of architecture practice. Founded by Robert Downey Jr in 2004, we’re an employee-owned firm pursuing a democratic design process that values everyone’s input.
                    </p>
                    <p class="lead">Today we have more than 150 people in London, Hong Kong and Sydney providing architecture, interior and urban design services from concept to completion.
                    </p>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="spec_item text-center">
                            <div class="spec_text">
                            <img src="img/icon/historical-building-outline-with-columns.png" alt="">
                            <h4>Our HISTORY</h4>
                ...
                <section class="meet_team_area">
                    <div class="container">
                        <div class="team_inner text-center">
                            ...
                            <a href="#" class="join"><h3>Join Our Team</h3></a>
                        </div>
                    </div>
                </section>
