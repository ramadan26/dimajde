;(function($) {
	...
	$('.menu-list li a').each(function() {
		...
		$this.on('click', function(e) {
			...
			$('.menu-list li a','.menu-list li div').removeClass('open');
			if (has) {
	...
	function fillter_slider() {
		if ($('.fillter_slider').length) {
			$('.fillter_slider').owlCarousel({
				...
				navText: ['<i class="ion-ios-arrow-left" style="color:#d6d7dd;"></i>', '<i class="ion-ios-arrow-right" style="color:#d6d7dd;"></i>'],
	...
	;function latest_project() {
		if ($('.our_projects_area, .project_full_inner').length) {
			$(".projects_inner, .project_full_inner").imagesLoaded(function() {
				$(".projects_inner, .project_full_inner").isotope({
					layoutMode: 'masonry',
					animationOptions: {
						duration: 750,
						easing: 'linear'
