...
(function (factory) {
		...
		_initTemplateDefaults: function () {
			...
			self.defaults = {
				...
				fileActionSettings: {
					...
					uploadRetryTitle: 'اعد الرفع',
					downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
					downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-secondary',
					downloadTitle: 'حمّل الملف',
					...
					indicatorNewTitle: 'لم يتم الرفع',
	...
	$.fn.fileinputLocales.en = {
		...
		browseLabel: 'تصفح',
		removeLabel: 'إحذف',
		removeTitle: 'إحذف الملفات المختارة',
		cancelLabel: 'خروج',
		cancelTitle: 'تم الغاء التحميل',
		uploadLabel: 'إرفع',
		uploadTitle: 'إرفم الملفات المختارة',
		msgNo: 'No',
		...
		msgFoldersNotAllowed: 'Drag & drop pdf file only! {n} folder(s) dropped were skipped.',
		...
		dropZoneTitle: 'حمّل ملفك هنا &hellip;',
